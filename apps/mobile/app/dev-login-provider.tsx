...
// Seed provider: Marie Kabila — Kinshasa/Gombe, role PROVIDER
const DEV_PHONE = '+243812345001';
const DEV_OTP = '1234';

export default function DevLoginProvider() {
  const { login } = useAuth();
  ...
  if (status === 'loading') {
    return (
      <View style={styles.screen}>
        ...
        <Text style={styles.hint}>Connexion prestataire dev…</Text>
        <Text style={styles.identity}>Marie Kabila · Kinshasa</Text>
      </View>
    );
  }
  ...
  return (
    <View style={styles.screen}>
      <Text style={styles.logo}>Karysm</Text>
      <Text style={styles.errorTitle}>Échec connexion prestataire</Text>
