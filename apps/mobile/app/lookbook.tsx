  ...
  const renderEmpty = () => {
    ...
    return (
      <View style={styles.emptyContainer}>
        ...
        <Text style={styles.emptySubtitle}>
          Nos professionnelles ajoutent leurs meilleures créations. Revenez vite !
        </Text>
        <Pressable style={styles.emptyCta} onPress={() => router.push('/(tabs)' as any)}>
          <Text style={styles.emptyCtaText}>Explorer les professionnelles</Text>
        </Pressable>
      </View>
    );
  };
      ...
      <View style={styles.header}>
        ...
        <View style={styles.headerText}>
          ...
          <Text style={styles.headerSubtitle}>
            Les réalisations de nos professionnelles
          </Text>
        </View>
      </View>
