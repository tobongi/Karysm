...
const styles = StyleSheet.create({
  ...
  // Title
  title: { fontSize: 22, fontWeight: '800', color: colors.accent, marginBottom: 4 },
  clientName: { fontSize: 14, color: colors.textSecondary, marginBottom: 16 },
  // Meta
  ...
  sectionTitle: { fontSize: 16, fontWeight: '700', color: colors.accent, marginBottom: 10 },
  descriptionText: { fontSize: 15, color: colors.text, lineHeight: 22 },
  // Photos
  photosRow: { flexDirection: 'row', gap: 8, flexWrap: 'wrap' },
  photoThumb: {
    width: 80, height: 80, borderRadius: 12, backgroundColor: '#F0ECFF',
  ...
  proposalAvatarText: { fontSize: 16, fontWeight: '700', color: colors.white },
  proposalInfo: { flex: 1 },
  proposalName: { fontSize: 15, fontWeight: '700', color: colors.accent },
  ...
  ratingValue: { fontSize: 12, fontWeight: '600', color: colors.terracotta, marginRight: 3 },
  reviewCount: { fontSize: 11, color: colors.textMuted },
  proposalPrice: { fontSize: 17, fontWeight: '800', color: colors.primary },
  proposalMessage: { fontSize: 14, color: colors.text, lineHeight: 20, marginBottom: 8 },
  proposalDuration: { fontSize: 13, color: colors.textSecondary },
  // Proposal actions
  ...
  modalTitle: { fontSize: 18, fontWeight: '800', color: colors.accent, marginBottom: 16 },
  modalClose: { paddingVertical: 12, alignItems: 'center' },
  modalCloseText: { fontSize: 14, color: colors.textSecondary },
  // Form
  formLabel: { fontSize: 13, fontWeight: '600', color: colors.text, marginTop: 12, marginBottom: 6 },
  formInput: {
    backgroundColor: colors.bg,
    borderWidth: 1,
    borderColor: colors.border,
