...
const styles = StyleSheet.create({
  ...
  cardTitle: { fontSize: 16, fontWeight: '700', color: colors.accent, marginBottom: 4 },
  cardDescription: { fontSize: 14, color: colors.textSecondary, lineHeight: 20, marginBottom: 12 },
  ...
  cardMetaText: { fontSize: 13, fontWeight: '600', color: colors.text },
  cardFooter: {
    flexDirection: 'row',
    justifyContent: 'space-between',
    alignItems: 'center',
  ...
  cardFooterText: { fontSize: 12, color: colors.textSecondary },
  ...
  proposalCountText: { fontSize: 11, fontWeight: '600', color: colors.primary },
});
